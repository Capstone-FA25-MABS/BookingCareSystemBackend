...
CREATE TABLE appointments (
    ...
    type VARCHAR(20) CHECK (type IN ('IN_PERSON', 'TELEHEALTH')) DEFAULT 'IN_PERSON',
    reason NVARCHAR(MAX),
    result NVARCHAR(MAX),
    created_at DATETIME NOT NULL DEFAULT GETDATE(),
    updated_at DATETIME NOT NULL DEFAULT GETDATE(),
...
INSERT INTO payment_methods (name, description) VALUES ('MOMO', 'Momo e-wallet');
INSERT INTO payment_methods (name, description) VALUES ('VN_PAY', 'VN Pay gateway');

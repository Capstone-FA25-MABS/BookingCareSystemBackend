...
public class BlogsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetBlogs([FromQuery] BlogFilterParameters filter, CancellationToken cancellationToken = default)
    {
    ...
    [Authorize]
    [ProducesResponseType(typeof(PagedResponse<BlogSummaryDto>), StatusCodes.Status200OK)]
    public async Task<IActionResult> GetMyBlogs([FromQuery] BlogFilterParameters filter, CancellationToken cancellationToken = default)
    {
    ...
    [HttpPut("{id:guid}")]
    [ProducesResponseType(typeof(BlogDetailDto), StatusCodes.Status200OK)]
    public async Task<IActionResult> UpdateBlog(Guid id, [FromBody] UpdateBlogRequest request, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="request">Approve request with optional featured status</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Approved blog</returns>
    ...
    /// <param name="id">Blog ID</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Rejected blog</returns>
    [HttpPost("{id:guid}/reject")]
    [ProducesResponseType(typeof(BlogDetailDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> RejectBlog(Guid id, CancellationToken cancellationToken = default)
    {
    ...
    private async Task DeleteBlogImageAsync(string? imageUrl, Guid accountId, CancellationToken cancellationToken)
    {

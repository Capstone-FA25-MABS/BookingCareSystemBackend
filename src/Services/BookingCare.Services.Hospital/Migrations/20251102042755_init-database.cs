        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    max_doctors = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    max_specialties = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    max_appointments = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_subscription_plans_max_appointments", "(max_appointments IS NULL OR max_appointments >= 0)");
                    table.CheckConstraint("CK_subscription_plans_max_doctors", "(max_doctors IS NULL OR max_doctors >= 0)");
                    table.CheckConstraint("CK_subscription_plans_max_specialties", "(max_specialties IS NULL OR max_specialties >= 0)");

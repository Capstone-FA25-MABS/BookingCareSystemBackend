...
public class HospitalFaqService : IHospitalFaqService
{
    ...
    public async Task<HospitalFaqListResponse> GetFaqsAsync(HospitalFaqFilterRequest filter, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<List<HospitalFaqResponse>> GetFaqsByHospitalIdAsync(Guid hospitalId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<HospitalFaqResponse?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
    {
        var faq = await _repository.GetByIdAsync(id, cancellationToken);
        return faq == null ? null : _mapper.Map<HospitalFaqResponse>(faq);
    }

    public async Task<HospitalFaqResponse> CreateFaqAsync(CreateHospitalFaqRequest request, Guid createdBy, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<HospitalFaqResponse> UpdateFaqAsync(Guid id, UpdateHospitalFaqRequest request, CancellationToken cancellationToken = default)
    {

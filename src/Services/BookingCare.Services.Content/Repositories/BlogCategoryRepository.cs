...
public class BlogCategoryRepository : IBlogCategoryRepository
{
    ...
    public BlogCategoryRepository(ContentDbContext dbContext, ILogger<BlogCategoryRepository> logger)
    {
        _dbContext = dbContext;
        _logger = logger;
    }

    public async Task<IReadOnlyList<BlogCategoryEntity>> GetAllAsync(
    ...
    public async Task<BlogCategoryEntity?> GetByIdAsync(
        Guid id,
